...
import { LP_NAVIGATION_ITEMS, LP_ACTION_BUTTONS, heroSectionProps, mentorSectionProps, journeySectionProps, icebreakerSectionProps, comparisonSectionProps, pricingSectionProps } from "@/common/constants/programas/ganhar-dinheiro-dolar-online-page.constants";
...
export default function Home() {
	...
	return <ProgramPage 
		...
		programId="ganhar-dinheiro-dolar-online"
	/>
}
