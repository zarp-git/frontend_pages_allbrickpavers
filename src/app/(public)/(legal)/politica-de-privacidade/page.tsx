...
export const metadata = useLegalMetadata(
  legalPagesConfig["politica-de-privacidade"].metadata,
);
    ...
    >
      ...
      <div className="bg-muted/50 rounded-lg p-6 mb-8">
        ...
        <nav className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm">
          ...
          <a
            href="#definicoes-importantes"
            className="text-primary hover:underline"
          >
            2. Definições Importantes
          </a>
          <a
            href="#dados-que-coletamos"
            className="text-primary hover:underline"
          >
            3. Dados que Coletamos
          </a>
          <a
            href="#bases-legais-e-finalidades"
            className="text-primary hover:underline"
          >
            4. Bases Legais e Finalidades
          </a>
          <a
            href="#como-usamos-os-dados"
            className="text-primary hover:underline"
          >
            5. Como Usamos os Dados
          </a>
          <a
            href="#compartilhamento-de-dados"
            className="text-primary hover:underline"
          >
            6. Compartilhamento de Dados
          </a>
          <a
            href="#seguranca-dos-dados"
            className="text-primary hover:underline"
          >
            7. Segurança dos Dados
          </a>
          <a
            href="#retencao-e-exclusao-de-dados"
            className="text-primary hover:underline"
          >
            8. Retenção e Exclusão de Dados
          </a>
          <a
            href="#direitos-dos-titulares"
            className="text-primary hover:underline"
          >
          ...
          <a href="#dados-de-menores" className="text-primary hover:underline">
            11. Dados de Menores
          </a>
          <a
            href="#cookies-e-tecnologias"
            className="text-primary hover:underline"
          >
            12. Cookies e Tecnologias
          </a>
          <a href="#comunicacoes" className="text-primary hover:underline">
            13. Comunicações
          </a>
          <a
            href="#incidentes-de-seguranca"
            className="text-primary hover:underline"
          >
            14. Incidentes de Segurança
          </a>
          <a
            href="#encarregado-de-protecao-de-dados"
            className="text-primary hover:underline"
          >
            15. Encarregado de Proteção de Dados
          </a>
          <a
            href="#autoridades-de-controle"
            className="text-primary hover:underline"
          >
            16. Autoridades de Controle
          </a>
          <a
            href="#alteracoes-nesta-politica"
            className="text-primary hover:underline"
          >
            17. Alterações nesta Política
          </a>
          <a
            href="#lei-aplicavel-e-foro"
            className="text-primary hover:underline"
          >
            18. Lei Aplicável e Foro
          </a>
          <a href="#glossario-tecnico" className="text-primary hover:underline">
      ...
      <section id="introducao">
        ...
        <p className="mb-4">
          O <strong>Ponte Américas</strong> ("nós", "nosso" ou "Programa"), um
          programa educacional abrangente baseado nos Estados Unidos, é dedicado
          a orientar brasileiros em sua jornada para viver, trabalhar e
          prosperar nos Estados Unidos.
        </p>
        <p className="mb-4">
          Esta Política de Privacidade informa sobre nossas práticas de coleta,
          uso, armazenamento e proteção de dados pessoais, em conformidade com:
        </p>
        ...
        <p className="mb-4">
          <strong>IMPORTANTE:</strong> Nosso programa está em constante
          evolução, com melhorias contínuas sendo implementadas, incluindo
      ...
      <section id="definicoes-importantes">
        ...
        <ul className="list-disc pl-6 mb-6 space-y-2">
          <li>
            <strong>"Programa Educacional"</strong>: Conjunto de cursos,
            materiais e orientações sobre imigração para os EUA
          </li>
          <li>
            <strong>"Participante"</strong>: Pessoa inscrita no programa
            educacional
          </li>
          <li>
            <strong>"Conteúdo Educacional"</strong>: Materiais didáticos,
            vídeos, PDFs, webinars e orientações
          </li>
          <li>
            <strong>"Plataforma"</strong>: Site e ambiente virtual de
            aprendizagem do Ponte Américas
          </li>
          <li>
          ...
          <li>
            <strong>"Mentoria"</strong>: Orientação personalizada sobre
            processos de imigração
          </li>
          <li>
            <strong>"Comunidade"</strong>: Ambiente de interação entre
      ...
      <section id="dados-que-coletamos">
        ...
        <h3 className="text-xl font-semibold mb-3">
          3.2 Dados de Perfil Educacional
        </h3>
        <ul className="list-disc pl-6 mb-4 space-y-2">
        ...
        <h3 className="text-xl font-semibold mb-3">
          3.4 Dados de Mentoria e Orientação
        </h3>
        <ul className="list-disc pl-6 mb-4 space-y-2">
        ...
        <h3 className="text-xl font-semibold mb-3">
          3.5 Dados de Pagamento e Financeiros
        </h3>
        <ul className="list-disc pl-6 mb-4 space-y-2">
      ...
      <section id="bases-legais-e-finalidades">
        ...
        <h3 className="text-xl font-semibold mb-3">
          4.1 Consentimento (Art. 7º, I da LGPD)
        </h3>
        <p className="mb-2">
          <strong>Dados:</strong> Informações sensíveis, participação na
          comunidade, dados opcionais
        </p>
        <p className="mb-2">
          <strong>Finalidade:</strong> Personalização da experiência educacional
          e interação social
        </p>
        <p className="mb-4">
          <strong>Como obtemos:</strong> Termo de consentimento específico no
          cadastro e durante o uso
        </p>
        ...
        <p className="mb-2">
          <strong>Dados:</strong> Informações de cadastro, progresso nos cursos,
          dados de pagamento
        </p>
        <p className="mb-4">
          <strong>Finalidade:</strong> Prestação dos serviços educacionais
          contratados
        </p>
        ...
        <p className="mb-2">
          <strong>Dados:</strong> Dados de uso, preferências de aprendizado,
          feedback
        </p>
        <p className="mb-4">
          <strong>Finalidade:</strong> Melhoria dos serviços educacionais e
        ...
        <p className="mb-2">
          <strong>Dados:</strong> Dados fiscais e financeiros, registros de
          acesso
        </p>
        <p className="mb-6">
          <strong>Finalidade:</strong> Cumprimento de obrigações tributárias e
          regulamentares
        </p>
      </section>
      ...
      <section id="como-usamos-os-dados">
        ...
        <h3 className="text-xl font-semibold mb-3">
          5.1 Prestação dos Serviços Educacionais
        </h3>
        <ul className="list-disc pl-6 mb-4 space-y-2">
        ...
        <h3 className="text-xl font-semibold mb-3">
          5.3 Melhoria e Desenvolvimento
        </h3>
        <ul className="list-disc pl-6 mb-4 space-y-2">
      ...
      <section id="compartilhamento-de-dados">
        ...
        <ul className="list-disc pl-6 mb-4 space-y-2">
          <li>
            <strong>Hospedagem</strong>: Provedores de nuvem para armazenamento
            seguro
          </li>
          <li>
            <strong>Pagamentos</strong>: Processadores de pagamento (Stripe,
            PayPal)
          </li>
          <li>
            <strong>Comunicação</strong>: Serviços de email e WhatsApp Business
          </li>
          <li>
            <strong>Analytics</strong>: Ferramentas de análise para melhoria do
            serviço
          </li>
        </ul>
        ...
        <ul className="list-disc pl-6 mb-4 space-y-2">
          ...
          <li>
            Não compartilhamos dados sensíveis sem consentimento explícito
          </li>
        </ul>
      ...
      <section id="seguranca-dos-dados">
        ...
        <ul className="list-disc pl-6 mb-4 space-y-2">
          <li>
            <strong>Criptografia TLS 1.3</strong> para dados em trânsito
          </li>
          <li>
            <strong>Criptografia AES-256</strong> para dados em repouso
          </li>
          <li>
            <strong>Autenticação multifator</strong> disponível
          </li>
          <li>
            <strong>Hashing seguro</strong> para senhas (bcrypt)
          </li>
          <li>
            <strong>Firewall</strong> e proteção DDoS
          </li>
          <li>
            <strong>Backups</strong> regulares e seguros
          </li>
          <li>
            <strong>Monitoramento</strong> 24/7 de segurança
          </li>
        </ul>
      ...
      <section id="conteudo-educacional">
        ...
        <h3 className="text-xl font-semibold mb-3">
          10.1 Personalização do Conteúdo
        </h3>
        <ul className="list-disc pl-6 mb-4 space-y-2">
      ...
      <section id="dados-de-menores">
        ...
        <ul className="list-disc pl-6 mb-4 space-y-2">
          <li>
            <strong>Menores de 16 anos</strong>: Consentimento expresso dos
            pais/responsáveis obrigatório
          </li>
          <li>
            <strong>16 a 18 anos</strong>: Consentimento do menor com ciência
            dos pais/responsáveis
          </li>
          <li>
            <strong>Verificação</strong>: Processo de verificação de idade no
            cadastro
          </li>
          <li>
            <strong>Acompanhamento</strong>: Participação dos responsáveis
            quando necessário
          </li>
        </ul>
      ...
      <section id="cookies-e-tecnologias">
        ...
        <ul className="list-disc pl-6 mb-4 space-y-2">
          <li>
            <strong>Autenticação</strong>: Manter sessão de login ativa
          </li>
          <li>
            <strong>Segurança</strong>: Prevenção de ataques CSRF
          </li>
          <li>
            <strong>Funcionalidade</strong>: Preferências de idioma e tema
          </li>
          <li>
            <strong>Progresso</strong>: Salvar posição em cursos e módulos
          </li>
        </ul>
        ...
        <ul className="list-disc pl-6 mb-4 space-y-2">
          <li>
            <strong>Google Analytics</strong>: Análise de uso da plataforma
          </li>
          <li>
            <strong>Hotjar</strong>: Melhoria da experiência do usuário
          </li>
          <li>
            <strong>Estatísticas</strong>: Métricas de engajamento educacional
          </li>
        </ul>
      ...
      <section id="comunicacoes">
        ...
        <p className="mb-2">
          <strong>Comunicações Transacionais (Sempre Enviadas):</strong>
        </p>
        <ul className="list-disc pl-6 mb-4 space-y-2">
        ...
        <p className="mb-2">
          <strong>Comunicações de Marketing (Requer Consentimento):</strong>
        </p>
        <ul className="list-disc pl-6 mb-4 space-y-2">
        ...
        <ul className="list-disc pl-6 mb-4 space-y-2">
          <li>
            <strong>Email</strong>: Canal principal para comunicações
          </li>
          <li>
            <strong>WhatsApp</strong>: Comunicações importantes e suporte
          </li>
          <li>
            <strong>Plataforma</strong>: Notificações internas
          </li>
          <li>
            <strong>SMS</strong>: Apenas para verificações de segurança
          </li>
        </ul>

        <h3 className="text-xl font-semibold mb-3">
          13.3 Gestão de Preferências
        </h3>
        <ul className="list-disc pl-6 mb-6 space-y-2">
      ...
      <section id="incidentes-de-seguranca">
        ...
        <ul className="list-disc pl-6 mb-4 space-y-2">
          <li>
            <strong>Detecção</strong>: Monitoramento 24/7 para identificação
            rápida
          </li>
          <li>
            <strong>Contenção</strong>: Medidas imediatas para limitar o impacto
          </li>
          <li>
            <strong>Avaliação</strong>: Análise completa do escopo e riscos
          </li>
          <li>
            <strong>Notificação</strong>: Comunicação aos afetados em até 72
            horas
          </li>
          <li>
            <strong>Correção</strong>: Implementação de medidas corretivas
          </li>
          <li>
            <strong>Transparência</strong>: Relatório detalhado sobre o ocorrido
          </li>
        </ul>

        <h3 className="text-xl font-semibold mb-3">
          14.2 Sua Responsabilidade
        </h3>
        <ul className="list-disc pl-6 mb-6 space-y-2">
      ...
      <section id="encarregado-de-protecao-de-dados">
        ...
        <p className="mb-2">
          <strong>Nome:</strong> Encarregado de Proteção de Dados
        </p>
        <p className="mb-2">
          <strong>Email:</strong> dpo@ponteamericas.com
        </p>
        <p className="mb-2">
          <strong>WhatsApp:</strong> +1 321 429-6742
        </p>
        <p className="mb-4">
      ...
      <section id="autoridades-de-controle">
        ...
        <p className="mb-3">
          Se não estiver satisfeito com nossa resposta, você pode contatar:
        </p>
        ...
        <ul className="list-disc pl-6 mb-4 space-y-2">
          <li>
            <strong>FTC</strong> - Federal Trade Commission
          </li>
        ...
        <p className="mb-2">
          <strong>União Europeia (se aplicável):</strong>
        </p>
        <ul className="list-disc pl-6 mb-6 space-y-2">
      ...
      <section id="alteracoes-nesta-politica">
        ...
        <ul className="list-disc pl-6 mb-4 space-y-2">
          <li>
            <strong>Alterações menores</strong>: Notificação na plataforma
          </li>
          <li>
            <strong>Alterações significativas</strong>: Email com 30 dias de
            antecedência
          </li>
          <li>
            <strong>Alterações substanciais</strong>: Novo consentimento pode
            ser solicitado
          </li>
        </ul>
        ...
        <p className="mb-6">
          Mantemos histórico de todas as versões desta política em:
          ponteamericas.com/privacidade/historico
        </p>
      </section>
      ...
      <section id="lei-aplicavel-e-foro">
        ...
        <p className="mb-4">
          ...
          especificamente pela LGPD, bem como pelas leis americanas aplicáveis
          quando o processamento ocorrer nos Estados Unidos.
        </p>
        <p className="mb-6">
          Para participantes brasileiros, fica eleito o foro brasileiro
          competente conforme legislação consumerista. Para demais jurisdições,
      ...
      <section id="glossario-tecnico">
        ...
        <ul className="list-disc pl-6 mb-6 space-y-2">
          <li>
            <strong>API</strong>: Interface de Programação de Aplicações
          </li>
          <li>
            <strong>Backup</strong>: Cópia de segurança dos dados
          </li>
          <li>
            <strong>Cookie</strong>: Pequeno arquivo armazenado no navegador
          </li>
          <li>
            <strong>Criptografia</strong>: Codificação para proteger dados
          </li>
          <li>
            <strong>Hash</strong>: Transformação irreversível de dados
          </li>
          <li>
            <strong>HTTPS</strong>: Protocolo seguro para navegação
          </li>
          <li>
            <strong>Token</strong>: Identificador único para autenticação
          </li>
          <li>
            <strong>TLS</strong>: Protocolo de segurança para dados em trânsito
          </li>
          <li>
            <strong>Firewall</strong>: Sistema de proteção contra acesso não
            autorizado
          </li>
        </ul>
      </section>
      ...
      <section id="contato">
        ...
        <p className="mb-2">
          <strong>Ponte Américas</strong>
        </p>
        <p className="mb-2">
          Programa Educacional de Imigração para os Estados Unidos
        </p>
        ...
        <ul className="list-disc pl-6 mb-4 space-y-2">
          <li>
            ...
            privacidade@ponteamericas.com
          </li>
          <li>
            <strong>Suporte Educacional</strong>: suporte@ponteamericas.com
          </li>
          <li>
            <strong>Geral</strong>: contato@ponteamericas.com
          </li>
          <li>
            <strong>WhatsApp</strong>: +1 321 429-6742
          </li>
        ...
        <p className="mb-2">
          <strong>Última revisão jurídica:</strong> 21/10/2025
        </p>
        <p className="mb-6">
          <strong>Próxima revisão programada:</strong> 21/04/2026
        </p>

        <hr className="my-8" />

        <p className="text-sm text-muted-foreground italic">
          O Ponte Américas está comprometido com a privacidade e proteção de
          seus dados pessoais. Esta política reflete nosso compromisso com a
          transparência, segurança e conformidade legal no tratamento de dados
          pessoais de nossos participantes.
        </p>
      </section>
    </LegalLayout>
  );
