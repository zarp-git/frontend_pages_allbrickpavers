...
export const metadata = useLegalMetadata(
  legalPagesConfig["termos-de-uso"].metadata,
);
    ...
    >
      ...
      <div className="bg-muted/50 rounded-lg p-6 mb-8">
        ...
        <nav className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm">
          ...
          <a href="#descricao" className="text-primary hover:underline">
            2. Descrição do Programa
          </a>
          <a href="#cadastro" className="text-primary hover:underline">
            3. Cadastro e Inscrição
          </a>
          <a href="#conteudo" className="text-primary hover:underline">
            4. Conteúdo Educacional
          </a>
          <a href="#uso-permitido" className="text-primary hover:underline">
            5. Uso Permitido
          </a>
          <a href="#propriedade" className="text-primary hover:underline">
            6. Propriedade Intelectual
          </a>
          <a href="#responsabilidades" className="text-primary hover:underline">
            7. Responsabilidades
          </a>
      ...
      <section id="aceitacao">
        ...
        <p className="mb-4 leading-relaxed">
          Ao acessar e utilizar o programa educacional{" "}
          <strong>Ponte Américas</strong> ("Programa", "Plataforma" ou
        ...
        <p className="mb-6 leading-relaxed">
          ...
          utilizar nossos serviços educacionais. O uso contínuo da plataforma
          constitui aceitação plena destes termos.
        </p>
      </section>
      ...
      <section id="descricao">
        ...
        <p className="mb-4 leading-relaxed">
          O Ponte Américas é um programa educacional abrangente dedicado a
          orientar brasileiros em sua jornada para viver, trabalhar e prosperar
          nos Estados Unidos. Nosso objetivo é fornecer conhecimento prático e
          estratégico para uma transição bem-sucedida.
        </p>
        ...
        <ul className="list-disc pl-6 mb-4 space-y-2">
          ...
          <li>
            Orientações sobre mercado de trabalho e oportunidades profissionais
          </li>
        ...
        <p className="mb-6 p-4 bg-yellow-50 border-l-4 border-yellow-400 rounded">
          <strong>Importante:</strong> O Ponte Américas oferece conteúdo
          educacional e informativo. Não somos escritório de advocacia,
          despachante ou agência de imigração. Para questões legais específicas,
      ...
      <section id="cadastro">
        ...
        <h3 className="text-xl font-medium mb-3">
          3.2 Responsabilidades do Participante
        </h3>
        <ul className="list-disc pl-6 mb-4 space-y-2">
        ...
        <h3 className="text-xl font-medium mb-3">
          3.3 Modalidades de Participação
        </h3>
        <ul className="list-disc pl-6 mb-6 space-y-2">
          <li>
            <strong>Acesso Gratuito:</strong> Conteúdos introdutórios e
            materiais básicos
          </li>
          <li>
            <strong>Programa Completo:</strong> Acesso total aos cursos e
            materiais exclusivos
          </li>
          <li>
            <strong>Mentoria Personalizada:</strong> Orientação individual
            especializada
          </li>
        </ul>
      </section>
      ...
      <section id="conteudo">
        ...
        <ul className="list-disc pl-6 mb-4 space-y-2">
          ...
          <li>
            Possibilidade de download para estudo offline (quando permitido)
          </li>
          <li>
            Atualizações regulares do conteúdo conforme mudanças legislativas
          </li>
        </ul>
        ...
        <p className="mb-6 p-4 bg-blue-50 border-l-4 border-blue-400 rounded">
          <strong>Aviso:</strong> O conteúdo educacional não substitui
          aconselhamento jurídico profissional. Cada caso de imigração é único e
          pode requerer orientação específica de advogados especializados.
        </p>
      </section>
      ...
      <section id="propriedade">
        ...
        <h3 className="text-xl font-medium mb-3">
          6.1 Direitos do Ponte Américas
        </h3>
        <ul className="list-disc pl-6 mb-4 space-y-2">
          ...
          <li>
            Metodologia e estrutura curricular são propriedade intelectual
          </li>
        ...
        <ul className="list-disc pl-6 mb-6 space-y-2">
          ...
          <li>
            Responsabilidade pela originalidade e legalidade do que publica
          </li>
        </ul>
      </section>
      ...
      <section id="limitacao">
        ...
        <p className="mb-4 leading-relaxed">
          O Ponte Américas oferece conteúdo educacional com fins informativos.
        ...
        <p className="mb-6 p-4 bg-red-50 border-l-4 border-red-400 rounded">
          <strong>Importante:</strong> Nossa responsabilidade máxima está
          limitada ao valor pago pelo programa no período de 12 meses anteriores
          ao evento.
        </p>
      </section>
      ...
      <section id="privacidade">
        ...
        <h3 className="text-xl font-medium mb-3">
          9.1 Compromisso com a Privacidade
        </h3>
        <ul className="list-disc pl-6 mb-4 space-y-2">
      ...
      <section id="modificacoes">
        ...
        <p className="mb-6 leading-relaxed">
          O uso continuado após as modificações constitui aceitação dos novos
          termos.
        </p>
      </section>
      ...
      <section id="rescisao">
        ...
        <h3 className="text-xl font-medium mb-3">
          11.1 Cancelamento pelo Participante
        </h3>
        <ul className="list-disc pl-6 mb-4 space-y-2">
        ...
        <h3 className="text-xl font-medium mb-3">
          11.2 Suspensão pelo Ponte Américas
        </h3>
      ...
      <section id="disposicoes">
        ...
        <p className="mb-4 leading-relaxed">
          ...
          especificamente pela legislação brasileira sobre educação, proteção de
          dados e direitos do consumidor.
        </p>

        <h3 className="text-xl font-medium mb-3">14.2 Foro Competente</h3>
        <p className="mb-4 leading-relaxed">
          Fica eleito o foro brasileiro competente para dirimir questões
          relacionadas a estes termos, conforme domicílio do contratante ou sede
        ...
        <p className="mb-4 leading-relaxed">
          ...
          acordo completo entre você e o Ponte Américas.
        </p>
        ...
        <p className="mb-4 leading-relaxed">
          Se qualquer disposição for considerada inválida, as demais
          permanecerão em pleno vigor e efeito.
        </p>

        <h3 className="text-xl font-medium mb-3">14.5 Idioma</h3>
        <p className="mb-6 leading-relaxed">
          Estes Termos são redigidos em português brasileiro. Em caso de
          tradução, a versão em português prevalecerá.
        </p>
      </section>
      ...
      <section id="vigencia">
        ...
        <p className="mb-4 leading-relaxed">
          Ao acessar nossa plataforma, criar uma conta ou utilizar nossos
          serviços educacionais, você confirma que:
        </p>
        <ul className="list-disc pl-6 mb-4 space-y-2">
      ...
      <div className="mt-8 p-6 bg-muted/50 rounded-lg">
        ...
        <div className="space-y-2">
          <p>
            <strong>Contato:</strong> contato@ponteamericas.com
          </p>
          <p>
            <strong>WhatsApp:</strong> +1 321 429-6742
          </p>
          <p>
            <strong>Suporte:</strong> Segunda a Sexta, 9h às 18h (Brasília)
          </p>
        </div>
        <p className="text-sm text-muted-foreground mt-4">
          Estes Termos de Uso foram elaborados em conformidade com o Código
          Civil Brasileiro, Código de Defesa do Consumidor, Marco Civil da
          Internet, LGPD e demais legislações aplicáveis à educação e proteção
          de dados.
        </p>
      </div>
    </LegalLayout>
