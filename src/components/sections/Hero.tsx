...
import { ArrowDown, Phone, ChevronLeft, ChevronRight, Calculator } from 'lucide-react';
      ...
      <div className="container mx-auto relative z-10 flex flex-col lg:flex-row items-center gap-12 lg:gap-[0px]">
        ...
        <div className="flex-1 flex flex-col items-start gap-6 relative z-30">
          ...
          <h1 className="h1 text-gray-900 text-left">
            The Best Specialists for <span className="text-primary block">PAVERS INSTALLATION</span>
          ...
          <div className="flex flex-wrap gap-4">
            <Button variant="brick" size="lg" className="h-14 px-8 text-base font-bold tracking-wide flex items-center gap-2 shadow-lg hover:shadow-xl transition-all">
              ...
              return (
                ...
                >
                  <div className={cn(
                    ...
                    isActive ? "border-[6px] border-white shadow-[0_20px_50px_rgba(0,0,0,0.2)]" : "border-0 opacity-50 contrast-75 brightness-90 grayscale-[0.3]"
                  )}>
                    <ComparisonSlider
                      ...
                      {...(!isActive && { className: "pointer-events-none w-full h-full" })}
                    />
