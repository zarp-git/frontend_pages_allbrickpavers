    ...
    <section className="py-20 bg-white overflow-hidden">
      ...
      */}
      ...
      <div className="container mx-auto px-4 mt-12 flex flex-wrap items-center justify-center gap-4">
        <Button variant="brick" size="lg" className="h-[52px] px-8 text-base font-medium uppercase min-w-[200px] flex items-center justify-center gap-2">
          CONTACT US NOW <Phone className="size-5" />
        </Button>
        <Button variant="brick-outline" size="lg" className="h-[52px] px-8 text-base font-medium uppercase min-w-[200px]">
          SEE MORE
        </Button>
      </div>
