  ...
  return (
    <>
      <form
        ...
        className="bg-white rounded-3xl p-6 border border-[#E5E7EB] border-solid flex flex-col gap-4 mt-10"
      >
        <h2 className="title-5 text-center">Realize seus sonhos na América</h2>
        <p className="text-center text-sm text-neutral-600 mb-2">
          Preenchendo abaixo o nosso time vai te ajudar a entender tudo sobre
          como funciona os EUA para você ficar tranquilo.{" "}
        </p>
