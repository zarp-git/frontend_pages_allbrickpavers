          ...
          <div className="flex-1 p-6 lg:p-6 flex flex-col justify-center gap-6">
            <div className="text-center lg:text-left">
              <p className="text-neutral-600 text-base font-medium leading-tight">
                ...
                <span
                  className={`inline-block w-12 text-center font-semibold font-mono ${timer.isExpired ? "text-red-600" : timer.timeLeft <= 60 ? "text-red-500" : "text-red-500"}`}
                >
                  {timer.formattedTime}
                </span>{" "}
                minutos. Digite seu e-mail abaixo para que possamos enviar
                também por lá!
              </p>
            </div>
