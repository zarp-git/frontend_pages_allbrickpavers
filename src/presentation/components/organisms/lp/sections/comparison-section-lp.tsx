...
import { GradientText } from "@/presentation/components/ui/gradient-text";
import { ComparisonHeader } from "@/presentation/components/lp/comparison/comparison-header";
import { ComparisonRow } from "@/presentation/components/lp/comparison/comparison-row";
...
export const ComparisonSectionLp = ({
  ...
  return (
    <section
      id="comparison"
      className="w-full px-4 lg:px-28 pt-20 pb-6 bg-white flex flex-col justify-center items-center gap-16 lg:gap-32 overflow-hidden"
        ...
        <div className="w-full max-w-[1200px] mx-auto mt-30">
          <div className="relative bg-zinc-950 rounded-[20px] p-4 lg:p-8 min-h-[500px] lg:min-h-[709px]">
            ...
            <div className="w-full max-w-[900px] lg:max-w-[1150px] mx-auto grid grid-cols-3 sm:grid-cols-[2fr_1fr_1fr] gap-2 lg:gap-4 mb-8 lg:mb-16 relative">
              ...
              <div className="flex justify-center">
                <div className="absolute -top-16 lg: flex justify-center">
                  <ComparisonHeader title={othersHeader} isMain={false} />
                </div>
              </div>
            </div>
            ...
            <div className="w-full max-w-[900px] lg:max-w-[1150px] mx-auto space-y-0">
              {rows.map((item, index) => (
                <ComparisonRow key={index} item={item} className="relative" />
              ))}
            </div>
          </div>
        </div>
