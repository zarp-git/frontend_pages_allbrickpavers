        ...
        <div className="flex flex-col xl:flex-row gap-8 lg:gap-12 justify-between items-center ">
          ...
          <div className="flex flex-col gap-2 max-w-xs md:max-w-2xl lg:max-w-176 text-center xl:text-left items-center xl:items-start">
            ...
            <p className="text-base sm:text-lg text-zinc-600">
              Ainda está em dúvida? Veja uma amostra das aulas que você
              desbloqueia ao entrar no Ponte Américas. Cada módulo combina
              informação prática, estratégia e experiência real para acelerar
            ...
            <div className="relative">
              ...
              <Marquee
                pauseOnHover
                className="flex py-2 sm:py-4 [--gap:1.5rem]"
                repeat={2}
              >
                {modules.map((lesson) => (
                  <article
