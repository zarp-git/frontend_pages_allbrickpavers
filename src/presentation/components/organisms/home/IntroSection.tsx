            ...
            <div className="w-full md:flex-1 flex flex-col gap-7 max-w-lg">
              ...
              <ul className="flex flex-col gap-4 text-muted-foreground font-rubik text-base list-disc pl-5">
                <li>
                  <span className="leading-relaxed">
                    Fear the work will be uneven or sink within months.
                  </span>
                </li>
                <li>
                  <span className="leading-relaxed">
                    Price that skyrockets mid-project or endless "extra"
                    charges.
                  </span>
                </li>
                <li>
                  <span className="leading-relaxed">
                    Contractor who disappears, delays, or abandons the job
                    halfway.
                  </span>
                </li>
              </ul>
              ...
              <div className="flex flex-wrap gap-4 mt-2">
                <Button
                  variant="brick"
                  size="lg"
                  className="px-8 h-[52px] text-base flex items-center justify-center"
                >
                  CONTACT US NOW <RiPhoneLine className="ml-2 size-6" />
                </Button>
                <Button
                  variant="brick-outline"
                  size="lg"
                  className="px-8 h-[52px] text-base"
                >
                  GALLERY
                </Button>
              </div>
