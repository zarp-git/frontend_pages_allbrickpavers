...
export const ProgramCard = ({
  ...
  return (
    <div
      className={`w-full h-full relative rounded-lg border bg-linear-to-br from-gray-900 to-black border-gray-800 overflow-hidden flex flex-col ${className}`}
    >
      ...
      <div className="p-4 flex-1 flex flex-col justify-between">
        ...
        <div className="mb-3">
          ...
          <div className="flex flex-row w-full items-center gap-2">
            <RiUserLine className="size-3 text-white/70" />
