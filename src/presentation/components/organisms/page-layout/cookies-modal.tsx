    ...
    >
      <div className="space-y-3">
        ...
        <p className="text-sm text-neutral-700 leading-relaxed">
          A Ponte Américas usa cookies, píxeis, tags e tecnologias semelhantes
          para medir audiência e personalizar sua experiência. Saiba mais sobre
          como utilizamos seus dados e cookies em nossa{" "}
          <Link
          ...
          . Clique em <strong>Aceitar todos</strong> para permitir todos os
          cookies, <strong>Apenas essenciais</strong> para limitar ao necessário
          para o funcionamento do site, ou <strong>Recusar todos</strong> para
